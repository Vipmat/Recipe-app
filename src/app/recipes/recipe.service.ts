...
export class RecipeService {
  ...
  private recipes: Recipe[] = [
    ...
    [
      new Ingredient('Biscuits', 11),
      new Ingredient('Nuts', 20)
    ]),
    new Recipe('Burger', 'Fast Food Bites', 'https://www.maxpixel.net/static/photo/1x/Food-Fries-Burger-Tasty-Fat-Delicious-Hamburger-4333831.jpg',
    [
